    ...
    <div class="bg-white b box-shadow">
        <div class="wrapper-md">
            ...
            <div class="" v-show="status.load">
                <div id="filters" class="b-b m-b-xl">
                    <div class="row m-b-xs">
                        <div class="col-md-12">
                            ...
                            <strong>Найдено {{needs.total}} компаний</strong>
                ...
                <div class="m-b-lg" v-for="user in needs.data">
                ...
                <div class="jumbotron text-center bg-white not-found" v-if="needs.data.length === 0">
    ...
    export default {
        ...
        methods: {
            load: function () {
                ...
                axios.post(`/api/need`,this.query)
                    .then(response => {
            ...
            loadNextPage: function () {
                ...
                if (this.needs.next_page_url !== null) {
                    this.status.submit = true;

                    axios.post(this.needs.next_page_url,this.query)
                        .then(response => {

                            let oldData = this.needs.data;
                            oldData = oldData.concat(response.data.data);

                            this.needs = response.data;
                            this.needs.data = oldData;
