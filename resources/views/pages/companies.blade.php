...
@section('content')
    ...
    <div class="bg-black-opacity">
        ...
        <section class="container-fluid hidden-xs">
            <div class="row">
                <div style="background:url(/img/header5.jpg) center center; background-size:cover">
                    ...
                    <div class="col-sm-8 wrapper-xl">
                        ...
                        <ul class="list-group no-bg no-borders pull-in m-t-lg basic-list-blue">
                            ...
                            <li class="list-group-item fadeInUp wow"  data-wow-offset="200"  data-wow-delay="1100">
                                <i class="icon-check pull-left text-lg m-r text-info"></i>
                               Uniten помогает решить конкретные задачи здесь и сейчас, а также сформировать видение на будущее, сэкономить время и ресурсы.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-sm-4 fadeInLeft animated" data-ride="animated" data-animation="fadeInLeft"
                        ...
                        <div class="m-b-xl">
                            ...
                            <p class="text-muted m-t-lg">
                                ...
                                страны в единое, органичное инфопространство.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row m-t-lg m-b-lg">
                    ...
                    <div class="col-md-10 m-b-xl">
                        <p class="h1 font-thin m-t-n l-h-1x padder-v text-black">Новости</p>

                        <div class="col-md-8 pull-in m-t-md">
                            <small>
                                Товарищи! постоянное информационно-пропагандистское обеспечение нашей деятельности способствует подготовки и реализации дальнейших направлений развития.
                            </small>
                        </div>
                    </div>
